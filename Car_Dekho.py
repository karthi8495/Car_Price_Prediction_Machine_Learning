...
model = joblib.load("D:\GUVI AI & ML\Capstoneproject3-Car Dekho\Car_Data_Structured\car_price_prediction_model.pkl")
label_encoders = joblib.load("D:\\GUVI AI & ML\\Capstoneproject3-Car Dekho\\Car_Data_Structured\\label_encoders.pkl")
scalers = joblib.load("D:\\GUVI AI & ML\\Capstoneproject3-Car Dekho\\Car_Data_Structured\\scalers.pkl")


# load dataset for filtering and identify similar data
data = pd.read_csv("D:\GUVI AI & ML\Capstoneproject3-Car Dekho\Car_Data_Structured\car_dekho_cleaned_dataset_Raw.csv")


#Set pandas option to handle future downcasting
...
input_background_color = "lightcoral"
result_background_color = "#fad8d8"
